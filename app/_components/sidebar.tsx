...
const Sidebar = () => {
  ...
  return (
    <>
        <aside
        ref={sidebarRef}
        className={cn("group/sidebar h-screen bg-secondary overflow-y-auto relative flex w-60 flex-col z-[50]",
        ...
        >
            ...
            <div
                ...
                className="opacity-0 group-hover/sidebar:opacity-100
                 transition cursor-ew-resize absolute h-full w-1 bg-primary/10 top-0 right-0"
            />
        </aside>
        <div
        ref={navbarRef}
